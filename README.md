...
1. How would you describe acessibility on the web to someone new to programming?
 - Acessibility on the web is the ability for someone who does not have the ability to use your website in the original format can alter it in a way that they can then use it.
2. Talk about 3 different things you can do to ensure your website is accessible.
    - make sure my web can be use with a screen reader
    - my website can be read in different language
3. How would you explain the concept of a variable to someone new to programming?
    - Variables in programming hold the value that you give to the variable.
4. What is the purpose of using functions in code?
    - Functions allow you to give what you are targetting action and tells them what to do.
